...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .dg-breadcrumb a { color: var(--text-secondary); text-decoration: none; font-weight: 500; transition: color 0.15s; }
    .dg-breadcrumb a:hover { color: var(--accent-primary); }
    .dg-breadcrumb-sep { color: var(--text-muted); font-size: 0.65rem; }
    .dg-breadcrumb-current { color: var(--text-primary); font-weight: 600; }
    ...
    .dg-title-group { display: flex !important; align-items: center !important; gap: 1rem !important; }
    ...
    .dg-page-title   { font-size: 1.35rem; font-weight: 800; letter-spacing: -0.025em; color: var(--text-primary); }
    .dg-page-subtitle { font-size: 0.75rem; color: var(--text-secondary); margin-top: 3px; }

    .dg-header-actions { display: flex !important; align-items: center !important; gap: 0.625rem !important; flex-wrap: wrap !important; }
    ...
    .dg-btn-back:hover { border-color: var(--border-active); color: var(--text-primary); transform: translateY(-1px); }
    ...
    .dg-btn-edit:hover { transform: translateY(-1px); box-shadow: 0 6px 20px rgba(59,91,219,0.22); }
    ...
    .dg-section-title::after { content: ''; flex: 1; height: 1.5px; background: var(--border); border-radius: 2px; }
    ...
    @media (max-width: 860px) { .dg-main-row { grid-template-columns: 1fr !important; } }
    ...
    .dg-card-title { font-size: 0.82rem; font-weight: 700; color: var(--text-primary); }
    .dg-card-body  { padding: 1.25rem; }
    ...
    @media (max-width: 600px) { .dg-info-grid { grid-template-columns: 1fr !important; } }
    ...
    .dg-field-value.mono { font-family: 'JetBrains Mono', monospace; font-size: 0.82rem; }
    .dg-field-value.empty { color: var(--text-muted); font-weight: 400; font-style: italic; }
    ...
    .dg-profile-card:last-child { margin-bottom: 0; }
    ...
    /* Sidebar info list */
    .dg-sidebar-list { padding: 0.75rem; display: flex; flex-direction: column; gap: 0.5rem; }
    .dg-sidebar-item {
        display: flex !important;
        align-items: center !important;
        justify-content: space-between !important;
    ...
    .dg-sidebar-label { font-size: 0.72rem; font-weight: 600; color: var(--text-secondary); }
    .dg-sidebar-val   { font-size: 0.78rem; font-weight: 700; color: var(--text-primary); font-family: 'JetBrains Mono', monospace; text-align: right; }
    ...
    .dg-badge-L       { background: var(--cyan-bg);     color: var(--cyan);    border: 1px solid var(--cyan-border); }
    .dg-badge-P       { background: var(--pink-bg);     color: var(--pink);    border: 1px solid var(--pink-border); }
    .dg-badge-success { background: var(--success-bg);  color: var(--success); border: 1px solid var(--success-border); }
    .dg-badge-warning { background: var(--warning-bg);  color: var(--warning); border: 1px solid var(--warning-border); }
    ...
    .dg-masa-kerja-val   { font-size: 1.1rem; font-weight: 800; color: var(--success); letter-spacing: -0.02em; }
    .dg-masa-kerja-label { font-size: 0.7rem; color: var(--success); font-weight: 600; opacity: 0.8; margin-top: 1px; text-transform: uppercase; letter-spacing: 0.06em; }

    @media (max-width: 640px) { .dg-wrapper { padding: 1.25rem 1rem; } .dg-page-title { font-size: 1.1rem; } }
</style>
    ...
    <div class="dg-main-row">
        ...
        <div>
            ...
            <div class="dg-card" style="margin-bottom:1.5rem;">
                <div class="dg-card-header">
                    <div class="dg-card-header-icon">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    </div>
                    ...
                    <div class="dg-info-grid">
                        ...
                        <div class="dg-field">
                            ...
                            <div class="dg-field-value">
                                ...
                                @else
                                    <span style="color:var(--text-muted);font-style:italic;font-weight:400;font-size:0.82rem;">—</span>
                                @endif
                            </div>
                        </div>
                        <div class="dg-field">
                        ...
                        <div class="dg-field">
                            ...
                            <div class="dg-field-value mono {{ !$guru->tanggal_lahir ? 'empty' : '' }}">
                                {{ $guru->tanggal_lahir ? \Carbon\Carbon::parse($guru->tanggal_lahir)->format('d MMMM Y') : 'Tidak diisi' }}
                            </div>
                        </div>
                        <div class="dg-field full">
                            <div class="dg-field-label">Alamat</div>
                            <div class="dg-field-value {{ !$guru->alamat ? 'empty' : '' }}" style="align-items:flex-start;padding-top:0.6rem;min-height:56px;white-space:normal;word-break:break-word;">
            ...
            <div class="dg-card">
                <div class="dg-card-header">
                    <div class="dg-card-header-icon">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path stroke-linecap="round" stroke-linejoin="round" d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg>
                    </div>
        ...
        <div>
            ...
            <div class="dg-profile-card">
                ...
                <div class="dg-sidebar-list">
                    <div class="dg-sidebar-item">
                        ...
                        <span class="dg-sidebar-val" style="font-family:'Plus Jakarta Sans',sans-serif;font-size:0.78rem;">{{ $guru->jabatan ?? '—' }}</span>
                    </div>
                    <div class="dg-sidebar-item">
                        <span class="dg-sidebar-label">Tingkat</span>
                        <span class="dg-sidebar-val" style="font-family:'Plus Jakarta Sans',sans-serif;">{{ $guru->pendidikan_terakhir ?? '—' }}</span>
                    </div>
                    <div class="dg-sidebar-item">
            ...
            <div class="dg-profile-card">
                ...
                <div style="padding:0.75rem; display:flex; flex-direction:column; gap:0.5rem;">
                    <a href="{{ route('admin.guru.edit', $guru->id) }}" style="display:flex !important;align-items:center !important;gap:0.625rem !important;padding:0.65rem 0.875rem;background:var(--blue-bg, #eff6ff);border:1.5px solid var(--blue-border, #bfdbfe);border-radius:10px;text-decoration:none;transition:all 0.2s;color:#2563eb;font-size:0.82rem;font-weight:700;">
                    ...
                    <a href="{{ route('admin.guru.index') }}" style="display:flex !important;align-items:center !important;gap:0.625rem !important;padding:0.65rem 0.875rem;background:var(--bg-elevated);border:1.5px solid var(--border);border-radius:10px;text-decoration:none;transition:all 0.2s;color:var(--text-secondary);font-size:0.82rem;font-weight:600;">
                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
                        Semua Guru
                    </a>
                </div>
            </div>
