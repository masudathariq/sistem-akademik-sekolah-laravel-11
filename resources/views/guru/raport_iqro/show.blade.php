...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-xl font-bold text-gray-800">📋 Detail Raport Iqro</h2>
            <p class="text-sm text-gray-500 mt-0.5">Rincian lengkap penilaian bacaan Iqro siswa.</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('guru.raport_iqro.download_pdf', $siswa->id) }}"
                target="_blank"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-5">
        <div class="px-5 py-3 border-b border-gray-100 bg-gray-50">
            <h3 class="font-semibold text-gray-700 text-sm">A. Penilaian Aspek Iqro</h3>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-5">
        <div class="px-5 py-3 border-b border-gray-100 bg-gray-50">
            <h3 class="font-semibold text-gray-700 text-sm">B. Ringkasan Bacaan</h3>
        </div>
        <div class="p-5">
            @if($bacaan)
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                        <p class="text-xs text-green-500 font-semibold mb-1">Pencapaian Bacaan</p>
                    ...
                    <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 text-center">
                        <p class="text-xs text-orange-500 font-semibold mb-1">📘 Iqro Terakhir</p>
                        <p class="text-base font-bold text-gray-800">{{ $bacaan->iqro_terakhir }}</p>
                        <p class="text-xs text-gray-500 mt-0.5">Halaman {{ $bacaan->halaman_terakhir }}</p>
                    </div>
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                        <p class="text-xs text-blue-500 font-semibold mb-1">🎯 Target Lanjutan</p>
                        <p class="text-base font-bold text-gray-800">{{ $bacaan->iqro_lanjut }}</p>
                        <p class="text-xs text-gray-500 mt-0.5">Halaman {{ $bacaan->halaman_lanjut }}</p>
                    </div>
                </div>
            @else
                <p class="text-sm text-gray-400 italic text-center py-4">Belum ada data bacaan.</p>
            @endif
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-5">
        <div class="px-5 py-3 border-b border-gray-100 bg-gray-50">
            <h3 class="font-semibold text-gray-700 text-sm">C. Nilai Ujian Iqro</h3>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-gray-50 text-xs text-gray-500 uppercase tracking-wider">
