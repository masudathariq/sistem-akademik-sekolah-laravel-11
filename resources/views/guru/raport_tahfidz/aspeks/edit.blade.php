...
<div class="w-full max-w-md">
    ...
    {{-- Back --}}
    <a href="{{ route('guru.raport-aspeks.index') }}"
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="px-8 py-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 class="text-lg font-bold text-gray-900 leading-tight">Edit Aspek Penilaian</h1>
                    <p class="text-sm text-gray-400 mt-0.5">Raport Tahfidz</p>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('guru.raport-aspeks.update', $aspek->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_aspek" id="nama_aspek"
                           value="{{ old('nama_aspek', $aspek->nama_aspek) }}"
    ...
    <p class="text-center text-xs text-gray-400 mt-5">
        Perubahan aspek akan langsung mempengaruhi input nilai siswa.
    </p>
