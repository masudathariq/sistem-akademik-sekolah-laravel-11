...
<div class="min-h-screen bg-gray-50 py-8 px-4">
    <div class="max-w-5xl mx-auto">
        ...
        <form action="{{ url('/staff_tu/siswa/'.$siswa->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit"
                        class="px-6 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition shadow-sm">
                    Update Siswa
                </button>
            </div>
