...
<div class="rb-page">
    ...
    <div class="top-bar">
        ...
        <div class="page-title">
            ...
            <div class="title-text">
                <h1>Edit Rombel</h1>
                <p>
                    Perbaharui data rombongan belajar secara modern dan profesional
                </p>
            </div>
    ...
    <div class="form-card">
        ...
        <div class="form-body">
            ...
            <div class="info-preview">
                ...
                <div class="info-preview-text">
                    ...
                    <p class="preview-label">
                        Data rombel saat ini
                    </p>

                    <p class="preview-value"
                       id="previewText">

                        Kelas {{ $rombel->tingkat == 7 ? 'VII' : ($rombel->tingkat == 8 ? 'VIII' : 'IX') }}

                        @if($rombel->kode_rombel)
                            - {{ $rombel->kode_rombel }}
                        @endif
                    ...
                    <p class="preview-old"
                       id="previewOldText">
                        Silakan lakukan perubahan data di bawah
                    </p>
            ...
            {{-- FORM --}}
            <form action="{{ url('/staff_tu/rombel/'.$rombel->id) }}"
                  method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="form-hint">
                            Tahun ajaran sudah terikat dengan data rombel ini.
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tingkat"
                            ...
                            <option value="7"
                                {{ $rombel->tingkat == 7 ? 'selected' : '' }}>
                                VII (Tujuh)
                            </option>

                            <option value="8"
                                {{ $rombel->tingkat == 8 ? 'selected' : '' }}>
                                VIII (Delapan)
                            </option>

                            <option value="9"
                                {{ $rombel->tingkat == 9 ? 'selected' : '' }}>
                                IX (Sembilan)
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('kode_rombel', $rombel->kode_rombel) }}"
                               autocomplete="off"
                               required>

                        <div class="form-hint">
                            Gunakan kode unik untuk identifikasi rombel.
                        </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="form-hint">
                            Nama lengkap atau julukan rombel.
                        </div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    const previewOld    = document.getElementById('previewOldText');

    const oldTingkat    = "{{ $rombel->tingkat }}";
    const oldKode       = "{{ $rombel->kode_rombel }}";
    const oldNama       = "{{ $rombel->nama_rombel }}";
    ...
    function updatePreview(){
        ...
        if(
            tingkatValue !== oldTingkat ||
            kodeValue !== oldKode ||
            namaValue !== oldNama
        ){

            previewOld.textContent = '⚠️ Ada perubahan yang belum disimpan';
            previewOld.style.color = '#d97706';

        }else{

            previewOld.textContent = 'Tidak ada perubahan';
            previewOld.style.color = '#94a3b8';
