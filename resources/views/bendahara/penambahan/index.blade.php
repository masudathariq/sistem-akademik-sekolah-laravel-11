...
<div class="container mx-auto p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">
            Kelola semua tunjangan untuk guru. Tambahkan, edit, atau hapus sesuai kebutuhan.
        </p>
    </div>
    ...
    <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1">
                <h3 class="font-semibold text-blue-800 mb-1">Tentang Data Tunjangan</h3>
                <p class="text-sm text-blue-700">
                    Setiap tunjangan dapat ditujukan untuk semua guru atau guru tertentu. Pastikan nominal dan tipe tunjangan sesuai agar perhitungan gaji benar.
                </p>
                <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-blue-700">
                    <div class="flex items-center gap-2">
                        <span class="font-semibold">💰 Jumlah:</span>
                        <span>Nominal tunjangan per guru</span>
                    </div>
                    <div class="flex items-center gap-2">
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $penambahans->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $penambahans->where('tipe', 'semua')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">{{ $penambahans->where('tipe', 'tertentu')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-800">Rp {{ number_format($penambahans->sum('jumlah'), 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4 flex justify-end">
        <a href="{{ route('bendahara.penambahan.create') }}"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($penambahans as $item)
                    <tr class="hover:bg-blue-50 transition-colors">
                        <td class="px-4 py-3">
                            <span class="font-medium text-gray-800">{{ $item->judul }}</span>
                        </td>
                        <td class="px-4 py-3 text-right">
                            <span class="font-semibold text-gray-800">Rp {{ number_format($item->jumlah,0,',','.') }}</span>
                        </td>
                        ...
                        <td class="px-4 py-3">
                            @if($item->tipe === 'semua')
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-blue-600 font-semibold text-sm">Semua Guru</span>
                                </div>
                            @else
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-700">{{ $guruMap[$gid] ?? 'Guru tidak ditemukan' }}</span>
                                    </div>
                                    @endforeach
                                </div>
                                @else
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('bendahara.penambahan.edit', $item->id) }}"
                                ...
                                <form action="{{ route('bendahara.penambahan.destroy', $item->id) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button onclick="return confirm('Hapus data tunjangan ini?')"
                    ...
                    <tr>
                        <td colspan="7" class="px-4 py-12 text-center">
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    <p class="text-gray-500 font-medium">Belum ada data tunjangan</p>
                                    <p class="text-sm text-gray-400 mt-1">Klik tombol "Tambah Tunjangan" untuk menambahkan data baru</p>
                                </div>
                            </div>
                        </td>
                    </tr>
